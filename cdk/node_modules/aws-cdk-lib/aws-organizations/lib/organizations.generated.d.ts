...
export declare class CfnOrganization extends cdk.CfnResource implements cdk.IInspectable, IOrganizationRef {
     ...
     */
    static fromOrganizationArn(scope: constructs.Construct, id: string, arn: string): IOrganizationRef;
    /**
...
export declare class CfnOrganizationalUnit extends cdk.CfnResource implements cdk.IInspectable, IOrganizationalUnitRef, cdk.ITaggable {
     ...
     */
    static fromOrganizationalUnitArn(scope: constructs.Construct, id: string, arn: string): IOrganizationalUnitRef;
    /**
...
export declare class CfnResourcePolicy extends cdk.CfnResource implements cdk.IInspectable, IResourcePolicyRef, cdk.ITaggable {
     ...
     */
    static fromResourcePolicyArn(scope: constructs.Construct, id: string, arn: string): IResourcePolicyRef;
    /**
