...
export declare class CfnSpace extends cdk.CfnResource implements cdk.IInspectable, ISpaceRef, cdk.ITaggable {
     ...
     */
    static fromSpaceArn(scope: constructs.Construct, id: string, arn: string): ISpaceRef;
    /**
...
export declare class CfnUserProfile extends cdk.CfnResource implements cdk.IInspectable, IUserProfileRef, cdk.ITaggable {
     ...
     */
    static fromUserProfileArn(scope: constructs.Construct, id: string, arn: string): IUserProfileRef;
    /**
