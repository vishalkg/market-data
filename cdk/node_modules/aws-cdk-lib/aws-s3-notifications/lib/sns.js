...
${JSON.stringify(statement.toJSON(),null,2)}`)}return{arn:this.topic.topicArn,type:s3().BucketNotificationDestinationType.TOPIC,dependencies:[this.topic]}}}exports.SnsDestination=SnsDestination,_a=JSII_RTTI_SYMBOL_1,SnsDestination[_a]={fqn:"aws-cdk-lib.aws_s3_notifications.SnsDestination",version:"2.219.0"};
