...
export declare class CfnLiveSource extends cdk.CfnResource implements cdk.IInspectable, ILiveSourceRef, cdk.ITaggableV2 {
     ...
     */
    static fromLiveSourceArn(scope: constructs.Construct, id: string, arn: string): ILiveSourceRef;
    /**
...
export declare class CfnVodSource extends cdk.CfnResource implements cdk.IInspectable, IVodSourceRef, cdk.ITaggableV2 {
     ...
     */
    static fromVodSourceArn(scope: constructs.Construct, id: string, arn: string): IVodSourceRef;
    /**
